...
FROM
    ...
    INNER JOIN countrylanguages cl 
    ON ct.country_code = cl.country_code;
...
FROM
    ...
    ON c.code = cl.country_code
WHERE
    (cl.country_code, cl.percentage) IN (
        SELECT
            country_code,
            MAX(percentage)
        FROM
